        ...
        <div class="row g-0 min-vh-100">
            ...
            <nav class="col-12 col-md-3 col-lg-2 bg-primary text-white sidebar p-4 d-flex flex-column align-items-center">
                ...
                <ul class="nav nav-pills flex-column w-100 mb-auto">
                    ...
                    <li>
                        <a class="nav-link text-white" href="#" onclick="mostrarSeccion('clases', event)">
                    ...
                    <li>
                        <a class="nav-link text-white" href="#" onclick="mostrarSeccion('tareas', event)">
                            <i class="bi bi-journal-text"></i> Tareas
                        </a>
                    </li>
                    <li>
                        <a class="nav-link text-white" href="#" onclick="mostrarSeccion('calificaciones', event)">
